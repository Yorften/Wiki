<div class="flex flex-col items-center justify-start w-full gap-4 h-[15vh] md:gap-0 md:h-[10vh] pt-2">
    <div class="flex flex-wrap items-center justify-around w-full">
        ...
        <div class="flex relative items-center w-3/5 md:w-2/5 border-t-2 shadow-xl h-12 rounded-lg focus-within:shadow-lg bg-white overflow-hidden order-last md:order-none">
